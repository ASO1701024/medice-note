...
--
-- テーブルの構造 `medicine_notice_time`
--

CREATE TABLE `medicine_notice_time` (
  `notice_id` int(8) NOT NULL COMMENT '通知ID',
  `medicine_id` int(8) NOT NULL COMMENT '薬ID',
  `notice_time` time NOT NULL COMMENT '通知時刻',
  `user_id` int(8) NOT NULL COMMENT 'ユーザーID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
--
-- テーブルのインデックス `medicine_notice_time`
--
ALTER TABLE `medicine_notice_time`
  ADD PRIMARY KEY (`notice_id`),
  ADD KEY `medicine_notice_time_medicine_medicine_id_fk` (`medicine_id`),
  ADD KEY `medicine_notice_time_user_user_id_fk` (`user_id`);
...
--
-- テーブルのAUTO_INCREMENT `medicine_notice_time`
--
ALTER TABLE `medicine_notice_time`
...
--
ALTER TABLE `take_time`
  MODIFY `take_time_id` int(8) NOT NULL AUTO_INCREMENT COMMENT '服用時刻ID';
...
--
-- テーブルの制約 `medicine_notice_time`
--
ALTER TABLE `medicine_notice_time`
  ADD CONSTRAINT `medicine_notice_time_medicine_medicine_id_fk` FOREIGN KEY (`medicine_id`) REFERENCES `medicine` (`medicine_id`),
  ADD CONSTRAINT `medicine_notice_time_user_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
