...
--
-- テーブルの構造 `user_two_factor_authentication`
--

CREATE TABLE `user_two_factor_authentication` (
  `user_id` int(11) NOT NULL COMMENT 'ユーザーID',
  `authentication_key` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '認証キー',
...
--
-- テーブルのインデックス `user_two_factor_authentication`
--
ALTER TABLE `user_two_factor_authentication`
  ADD UNIQUE KEY `user_two_factor_authentication_authentication_key_uindex` (`authentication_key`),
  ADD KEY `user_two_factor_authentication_user_user_id_fk` (`user_id`);
...
--
-- テーブルの制約 `user_two_factor_authentication`
--
ALTER TABLE `user_two_factor_authentication`
  ADD CONSTRAINT `user_two_factor_authentication_user_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
COMMIT;
