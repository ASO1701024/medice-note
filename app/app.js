...
module.exports = {
    ...
    validationMedicine: async (array) => {
        ...
        let errorMessage = {
            ...
            'required.number': '1以上99以下の数字で入力してください',
            'numeric.number': '1以上99以下の数字で入力してください',
            'min.number': '1以上99以下の数字で入力してください',
            'max.number': '1以上99以下の数字で入力してください',
            'required.startsDate': '日付の書式で入力してください',
            'date.startsDate': '日付の書式で入力してください',
            'required.period': '1以上で1000以内の数字で入力してください',
            'numeric.period': '1以上で1000以内の数字で入力してください',
            'min.period': '1以上で1000以内の数字で入力してください',
            'max.period': '1以上で1000以内の数字で入力してください',
